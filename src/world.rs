...
pub struct WorldData {
    ...
    pub blocks: Vec<(String, Vec<i8>, String, String, bool)>,
...
impl WorldData {
    ...
    pub fn add_block(&mut self, block_name: String, sides: Vec<i8>, owner: String, shape: String, render_sides: bool) {
        if !self.block_index.contains_key(&block_name) {
            self.blocks.push((block_name.clone(), sides, owner, shape, render_sides));
