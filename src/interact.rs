...
pub fn break_block(game_data: &mut common::GameData, world_data: &mut world::WorldData) -> (Vec<common::Vertex>, i32, Vec<common::Vertex>) {
...
pub fn place_block(game_data: &mut common::GameData, world_data: &mut world::WorldData, slot_selected: i8, inventory: containers::Inventory) -> (Vec<common::Vertex>, i32, Vec<common::Vertex>) {
    let forward = cgmath::Vector3::new(
        game_data.camera_rotation[1].cos() * game_data.camera_rotation[0].cos(),
        game_data.camera_rotation[0].sin(),
        game_data.camera_rotation[1].sin() * game_data.camera_rotation[0].cos(),
