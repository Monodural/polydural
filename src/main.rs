...
fn main(){
    ...
    let (chunk_vertices, chunk_normals, chunk_colors) = chunk::render_chunk(&chunk_data);
    let vertex_data_chunk = create_vertices(chunk_vertices, chunk_normals, chunk_colors);
